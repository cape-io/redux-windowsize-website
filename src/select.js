...
import { gte as maxWidth, lt as minWidth, pick } from 'lodash/fp'
import { createSelector, createStructuredSelector } from 'reselect'
import { sizeIdSelector } from 'redux-windowsize'
...
export const mediaSizes = createSelector(getWindowWidth, createStructuredSelector({
  isNarrow, isMedium, isWide, sizeId,
}))
